...
/* ---------------------------------------------
 ...
 $(document).ready(function() {
    ...
    // Show the cookie consent banner if the user has not yet accepted cookies
    if (window.localStorage.getItem("accept_cookies") === null) {
      $("#cookie-consent").css("display", "block");
    }
  
    // When the user clicks the OK button, hide the cookie consent banner and store the fact that they have accepted cookies
